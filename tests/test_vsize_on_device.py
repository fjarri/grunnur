...
_VSTESTS = [
    ...
    VirtualSizesTest(
        global_size=(51, 201), local_size=(5, 10), max_num_groups=(16, 16), max_local_sizes=(8, 8)
    ),
    # Same thing, but with unspecified local size
    VirtualSizesTest(
        global_size=(51, 201), local_size=None, max_num_groups=(16, 16), max_local_sizes=(8, 8)
    ),
]
