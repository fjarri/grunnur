...
from grunnur import all_api_ids, cuda_api_id, opencl_api_id
...
def test_import_opencl_api(mock_backend_pyopencl: MockPyOpenCL) -> None:
...
def test_import_any_api(mock_backend_factory: MockBackendFactory) -> None:
...
def test_any_api_none_available() -> None:
    with pytest.raises(ImportError):
        from grunnur import any_api  # noqa: PLC0415


def test_grunnur_import_error() -> None:
