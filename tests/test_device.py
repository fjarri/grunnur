...
from grunnur._adapter_base import DeviceType
from grunnur._testing import MockPyCUDA, MockPyOpenCL, PyCUDADeviceInfo, PyOpenCLDeviceInfo
...
def test_device_parameters_opencl_cuda1(mock_backend_pyopencl: MockPyOpenCL) -> None:
    ...
    device_info = PyOpenCLDeviceInfo(
        extensions=["cl_nv_device_attribute_query"], compute_capability_major_nv=1, warp_size_nv=7
    )
...
def test_device_parameters_opencl_cuda2(mock_backend_pyopencl: MockPyOpenCL) -> None:
    ...
    device_info = PyOpenCLDeviceInfo(
        extensions=["cl_nv_device_attribute_query"], compute_capability_major_nv=2, warp_size_nv=7
    )
