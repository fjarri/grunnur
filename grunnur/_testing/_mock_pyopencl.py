...
class MockPyOpenCL:
    ...
    @property
    def pyopencl(self) -> MockPyOpenCLModule:
        return MockPyOpenCLModule(self)

    def add_platform(self, platform_name: str | None = None) -> Platform:
    ...
    def add_platform_with_devices(
        ...
        for device_info in device_infos:
            if isinstance(device_info, str):
                typed_device_info = PyOpenCLDeviceInfo(name=device_info)
            else:
...
class PyOpenCLDeviceInfo:
    def __init__(
        ...
        type_: DeviceType = DeviceType.GPU,
        ...
        compute_capability_major_nv: int | None = None,
        warp_size_nv: int | None = None,
    ):
        self.name = name
        self.vendor = vendor
        self.type = type_
...
class Program:
    ...
    def build(
        ...
        assert devices[0] in self.context.devices
...
class Kernel:
    ...
    def __call__(
        ...
        *args: Buffer | numpy.generic,
        ...
        assert 1 <= len(global_size) <= 3  # noqa: PLR2004
...
class Buffer:
    def __init__(
        ...
        flags: Any,
        size: int,
        _migrated_to: Device | None = None,
        _offset: int = 0,
        _base_buffer: Buffer | None = None,
    ):
        self.context = context
        self.flags = flags
        self.size = size
